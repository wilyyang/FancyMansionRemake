...
import com.cheesejuice.fancymansion.domain.entity.readbook.book.*
...
object Sample {
    ...
    private val logics = mutableListOf(
        ...
        PageLogicEntity(pageId = 100000000, pageTitle = "더 이상 존 크리스탈을 찾을 수 없습니다...", type = PageType.END.ordinal),
        PageLogicEntity(
        ...
        PageLogicEntity(pageId = 900000000, pageTitle = "아니 이 녀석 집에 있었잖아?", type = PageType.END.ordinal)
    )

    private val logic = LogicEntity(
        bookId = bookId,
        logics = logics
    )
